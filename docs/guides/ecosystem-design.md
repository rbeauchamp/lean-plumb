...
| D4 Rule scope | Preserve all twenty-one selected predicates and nine residual accounts. Mandatory project requirements remain mandatory. Keep upstream advisory linters identifiable as upstream. | Enable every ecosystem lint or invent a style tier to resemble another tool; rejected. | #13/#10 |
