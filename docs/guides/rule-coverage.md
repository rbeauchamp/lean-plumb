...
| PL1005 | Exact admissible transitive set exceeds the selected surface maximum. | Policy.permits/labelOfMember/ruleForMember label-exceeds-claim; #6 proofs; declarationFinding. | Environment and current configuration; project/fence with explicit claim/editor with known scope. | Kernel-only empty; Choice-Free subset of propext/Quot.sound; Standard-Logical additionally choice. Classical erased proofs permitted under that maximum. |
