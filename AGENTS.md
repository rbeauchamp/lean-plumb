...
- Operator-approved exception: the existing `Install Elan and pinned Lean` step in
  `.github/workflows/ci.yml` may use shell solely to install pinned Elan/Lean and
