...
On `main` only, after both and a gate refusing a dirty artifact or a revision that is no
longer the head of `main`, it deploys that exact artifact to GitHub Pages and compares the
