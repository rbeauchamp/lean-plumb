...
theorem binding_congr (a b ra rb : Json) (mode : Plumb.EvidenceMode)
...
theorem observedSources_congr (a b : Json) (bound : Plumb.Website.ExampleBinding)
...
theorem sourceAccount_congr (a b : Json) (bound : Plumb.Website.ExampleBinding) (displayed : String)
...
theorem effectiveAccount_congr (a b : Json) (admitted : Plumb.Website.ExampleRequest)
...
theorem requestAccount_congr (a b : Json) (bound : Plumb.Website.ExampleBinding)
...
end Plumb.Checker.RuleExampleProjection
