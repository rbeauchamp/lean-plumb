...
public import PlumbCore.EditorPolicy

public section

/-! Local declaration decisions run the claimed `PlumbCore.EditorPolicy` registrations
(`checkedEditorRequest`, `checkedEditorDecision`); `PlumbCore.Policy` proves they select the
