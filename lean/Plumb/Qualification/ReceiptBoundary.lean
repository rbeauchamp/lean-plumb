...
namespace Plumb.Qualification.ReceiptBoundary
open Lean System
      ...
      for fault in #["missing", "unusable", "spawn"] do
        ...
        let result ← IO.Process.output {
          ...
          env := #[("PATH", some bin.toString),
            ("PLUMB_QUALIFICATION_WRAPPER", none),
            ("PLUMB_RECEIPT_TIMER", if fault == "spawn" then some "1" else none)] }
...
end Plumb.Qualification.ReceiptBoundary
