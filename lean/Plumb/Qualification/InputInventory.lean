import Plumb.Qualification.DependencySnapshot
...
namespace Plumb.Qualification.InputInventory
...
def check : IO Unit := do
  ...
  withScratch root "input-inventory" fun scratch => do
    ...
    let env := cleanEnv ++ #[("PLUMB_QUALIFICATION_WRAPPER", some "inventory"),
...
end Plumb.Qualification.InputInventory
