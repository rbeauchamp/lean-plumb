...
def paired : IO Unit := do
  ...
  try
    withScratch root "launcher-pair" fun scratch => do
      ...
      requireChecks [⟨"36 exact paired controls", PlumbQualification.Launcher.checkedEquivalence.run before after⟩]
