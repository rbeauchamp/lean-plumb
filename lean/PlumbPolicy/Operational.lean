...
- an authored `unsafe` or `partial` declaration (an escape hatch, PL1006), which environment
...
theorem checkedOperationalFailure :
    Plumb.ExecutableContract operationalFailure OperationalFailureContract :=
