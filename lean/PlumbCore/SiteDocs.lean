...
def creditsPage (ident : Identity) : Except String String := do
  ...
  return header [] "Credits and licenses" "credits" (some "credits") (split := false) ++ notice ++ "\n" ++
    ...
    "Crediting a project does not imply its endorsement of Plumb. The complete attribution account is in the " ++ "[design-influences guide](" ++ blobUrl ident "docs/guides/design-influences.md" ++ ").\n\n" ++
    "{licenseInfo}\n"
