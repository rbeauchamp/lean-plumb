...
theorem evaluate_success (checks : List Check) :
  ...
  rw [evaluate_eq_forM, PlumbPolicy.Guards.listForM_eq_ok]
...
theorem evaluate_error (checks : List Check) (label : String) :
  ...
  rw [evaluate_eq_forM, PlumbPolicy.forM_eq_error]
...
theorem checkedEvaluation : Plumb.ExecutableContract evaluate EvaluationContract :=
