...
import StrictLeanQualification.Launcher
...
namespace StrictLean.Qualification.Launcher
open Lean System StrictLeanQualification.Launcher

/-- One validated mapping plus its actual PATH-resolved executable. -/
structure Captured where
  environment : {env : StrictLeanQualification.Launcher.Environment // Valid env}
  executable : String
...
end StrictLean.Qualification.Launcher
