...
public meta import StrictLean.MaterialClaim
public meta import StrictLean.Findings
...
namespace StrictLean.Linter.Documentation
open Lean
...
def declarationFinding (env : Environment) (decl : StrictLeanPolicy.Declaration)
...
end StrictLean.Linter.Documentation
