...
- `lake lint -- --json-out tmp/regula.json` also writes every finding with its location, remedy and rule guidance (result schema 3); `complete` is false when evidence was missing.
